...
def visualize_combined_curves(exp_r, exp_avg, exp_curves, theory_r, theory_puf, xi_u, params, savepath):
    ...
    # 只绘制前50条轨迹，避免图形过于拥挤
    num_trajectories_to_plot = min(50, len(exp_curves))
    ...
    title += f'Parameters: $E={params["E"]}$, $ξ_f={params["xi_f"]}$, $ξ_u={params["xi_u"]}$'
...
def main():
    ...
    # 文件路径
    exp_r_file = '/home/tyt/project/Single-chain/opt+force/2-state_comparation/results/r_values.csv'
    exp_n_file = '/home/tyt/project/Single-chain/opt+force/2-state_comparation/results/n_values.csv'
    savepath = '/home/tyt/project/Single-chain/opt+force/2-state_comparation/results/compare_n_r_curves.png'
