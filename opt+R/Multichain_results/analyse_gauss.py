...
Gaussian: {'Yes' if result['is_gaussian'] else 'No'}"""
    ...
    plt.savefig(f'/home/tyt/project/Single-chain/opt+R/Multichain_results/gaussian_analysis_result.png', dpi=150, bbox_inches='tight')
...
def main():
    ...
    filepath = "/home/tyt/project/Single-chain/opt+R/Multichain_results/energy_eff.txt"
