...
def main():
    ...
    n_file_path = "/home/tyt/project/Single-chain/opt+R/Rand_energy/results/n_values.csv"  # 替换为您的n_values.csv文件路径
    output_path = "/home/tyt/project/Single-chain/opt+R/Rand_energy/results/n_r_analysis.png"  # 替换为您想要保存的输出路径
    fill_value = 5.0  # 插值时用于填充缺失数据的值
