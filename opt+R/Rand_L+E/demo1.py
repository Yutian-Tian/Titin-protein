...
def plot_f_r_curves(df1, df2, f_upper_limit=None, title="f-r Curves", save_figure=False):
    ...
    if save_figure:
        if f_upper_limit is not None:
            filename1 = f'/home/tyt/project/Single-chain/opt+R/Rand_L+E/column_format/f_r_curves_filtered{f_upper_limit}_gray.png'
        else:
            filename1 = '/home/tyt/project/Single-chain/opt+R/Rand_L+E/column_format/f_r_curves_gray.png'
    ...
    # 保存第二个图形
    if save_figure:
        filename2 = '/home/tyt/project/Single-chain/opt+R/Rand_L+E/column_format/f_r_curves_all_data_gray.png'
